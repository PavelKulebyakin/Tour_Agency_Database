package ru.mirea.database.security.service;
...
import ru.mirea.database.service.user.impl.UserServiceImpl;
...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    protected Set<GrantedAuthority> mapRolesToAuthorities(Set<Role> roles) {
        return roles.stream()
