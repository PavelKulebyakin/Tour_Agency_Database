...
public class HousingSpecification implements Specification<Housing> {
    ...
    public Predicate toPredicate
        ...
        SearchOperation operation = SearchOperation.valueOf(criteria.getOperation().toUpperCase());             // TODO: 29.10.2023 add check
...
//        switch (operation) {
//
//            case EQUAL -> builder.equal(path.as(String.class), value);
